...
class Notapegawai extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'notapegawai/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'notapegawai/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'notapegawai/index.html';
            $config['first_url'] = base_url() . 'notapegawai/index.html';
        }
        ...
        $this->template->load('template_pegawai','pegawai/nota/tbl_nota_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'isservice' => $row->isservice,
            ...
            $this->template->load('template_pegawai','pegawai/nota/tbl_nota_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('notapegawai'));
        }
    }
    ...
    public function create() 
    {
        ...
        if($this->uri->segment(3) == '1'){
            $data = array(
                'button' => 'Services',
                'action' => site_url('notapegawai/create_services'),
            ...
            $data = array(
                ...
                'action' => site_url('notapegawai/create_pembelian'),
                'id_nota' => set_value('id_nota'),
        ...
        $this->template->load('template_pegawai','pegawai/nota/tbl_nota_createnew', $data);
    }
    ...
    public function create_services() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            redirect(base_url('notapegawai/create/1'));
            // $this->create();
        } else {
            $data = array(
        		'nomor' => $this->input->post('nomor',TRUE),
            ...
            redirect(site_url('notapegawai/updatenew/'.$id_nota));
        }
    }
    ...
    public function create_pembelian() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            redirect(base_url('notapegawai/create/0'));
            // $this->create();
        } else {
            $data = array(
        'nomor' => $this->input->post('nomor',TRUE),
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            if($row->isservice == '1'){
                $data = array(
                    'button' => 'Services',
                    'action' => site_url('notapegawai/update_service'),
                ...
                $data = array(
                    'button' => 'Pembelian Produk',
                    'action' => site_url('notapegawai/update_produk'),
                    'id_nota' => set_value('id_nota', $row->id_nota),
                    'nomor' => set_value('nomor', $row->nomor),
                    'penerimanota' => set_value('penerimanota', $row->penerimanota),
                    'nomortelepon' => set_value('nomortelepon', $row->nomortelepon),
            ...
            $data['namapegserv'] = $this->Nota_m->getnamapegserv("tbl_peg_service");
            $this->template->load('template_pegawai','pegawai/nota/tbl_nota_formupdate', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('notapegawai'));
        }
        ...
        if ($row) {
            if($row->isservice == '1'){
                $data = array(
                    ...
                    'action' => base_url('notapegawai/update_service'),
                    'id_nota' => set_value('id_nota', $row->id_nota),
                    'nomor' => set_value('nomor', $row->nomor),
                    'penerimanota' => set_value('penerimanota', $row->penerimanota),
                    'nomortelepon' => set_value('nomortelepon', $row->nomortelepon),
                ...
                $data = array(
                    ...
                    'action' => base_url('notapegawai/update_produk'),
                    'id_nota' => set_value('id_nota', $row->id_nota),
                    'nomor' => set_value('nomor', $row->nomor),
                    'penerimanota' => set_value('penerimanota', $row->penerimanota),
                    'nomortelepon' => set_value('nomortelepon', $row->nomortelepon),
            ...
            $data['namapegserv'] = $this->Nota_m->getnamapegserv("tbl_peg_service");
            $this->template->load('template_pegawai','pegawai/nota/tbl_nota_updatenew', $data);
        }
    }
    ...
    public function update_produk() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Nota_m->update($this->input->post('id_nota', TRUE), $data);
            $this->session->set_flashdata('message', 'Update Record Success');
            redirect(site_url('notapegawai/updatenew/'.$id));
        }
    }
    ...
    public function simpandatanota(){
            ...
            $this->session->set_flashdata('message', 'Create Record Success');
            redirect(site_url('notapegawai/updatenew/'.$this->input->post('id_nota')));
    }
    ...
    public function hapusdatanota($id){
        ...
        redirect(site_url('notapegawai/updatenew/'.$ind));
    }
