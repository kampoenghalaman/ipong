...
<body class="page-header-fixed">
  ...
  <div class="header navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="navbar-inner">
      <div class="container-fluid">
        <!-- BEGIN LOGO -->
        <a class="brand" href="<?php echo base_url();?>pegawai/home">
          <?php
        ...
        <li class="dropdown" id="header_inbox_bar">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li class="external">
                <a href="<?php echo base_url();?>pegawai/buku_tamu">See all messages <i class="m-icon-swapright"></i></a>
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown" id="header_inbox_bar">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li class="external">
                <a href="<?php echo base_url();?>pegawai/transaksi">See all Transaksi <i class="m-icon-swapright"></i></a>
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown user">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="<?php echo base_url();?>pegawai/logout"><i class="icon-key"></i> Log Out</a></li>
            </ul>
          </li>
    ...
    <div class="page-sidebar nav-collapse collapse">
      ...
      <ul class="page-sidebar-menu">
        ...
        <li class="start active">
          <a href="<?php echo base_url();?>pegawai/home">
          <i class="icon-home"></i> 
         ...
         <li >
          ...
          <ul class="sub-menu">
            ...
            <li >
              <a href="<?php echo base_url();?>pegawai/semua_transaksi">
          ...
          <ul class="sub-menu">
            <li >
              <a href="<?php echo base_url();?>pegawai/kategorigaleri">
              Album</a>
            </li>
            <li >
              <a href="<?php echo base_url();?>pegawai/galeri">
              Gallery</a>
            </li>
        ...
        <div class="row-fluid">
          <div class="span12">
            ...
            <ul class="breadcrumb">
              <li>
                <i class="icon-home"></i>
                <a href="<?php echo base_url();?>pegawai/home">Home</a> 
  ...
  <div class="footer">
    <div class="footer-inner">
      2018 &copy; IMC Online Shop - Admin Dashboard.
    </div>
