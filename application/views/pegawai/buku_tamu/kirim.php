...
<div class="row-fluid inbox">
	...
	<tbody>
		...
		<tr >
			...
			<td class="inbox-small-cells"> <a href="<?php echo base_url();?>pegawai/buku_tamu_kirim_hapus/<?php echo $tampil['id_hubungi_kami_kirim'];?>" onclick="return confirm('Anda yakin ingin mengahapus pesan ?');">  <i class="icon-trash"></i></a></td>
			<td class="view-message  hidden-phone"><b><a href="<?php echo base_url();?>pegawai/buku_tamu_kirim_detail/<?php echo $tampil['id_hubungi_kami_kirim'];?>"><?php echo $tampil['kepada'];?></a></b></td>
			<td class="view-message "><b><a href="<?php echo base_url();?>pegawai/buku_tamu_kirim_detail/<?php echo $tampil['id_hubungi_kami_kirim'];?>"><?php echo substr($tampil['judul'],0,50);?></a></b></td>
			</tr>
