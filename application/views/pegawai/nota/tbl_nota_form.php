    <body>
        <h2 style="margin-top:0px">Nota <?php echo $button ?> | <a href="<?php echo site_url('notapegawai'); ?>" class="btn btn-default">Batal</a></h2>
    ...
    <div class="row">
	    ...
	    <div class="form-group">
            ...
            <select name="namateknisi" id="namateknisi">
                <option value="" selected>Pilih Nama Teknisi</option>
...
<!--         <div class="span10">
	    ...
	    <a href="<?php echo site_url('notapegawai') ?>" class="btn btn-default">Cancel</a>
        </div>
	</form>
    </div>
  </div>
