...
?>
    <body>
        <h2 style="margin-top:0px">Nota <?php echo $jenis." | ".anchor(site_url('notapegawai/updatenew/'.$id_nota),"<input type='button' class='btn btn-primary' value='Update'/>");?> </h2>
        <table class="table">
    	   <?php echo $header;?>
        </table>
        <br>
        ...
        <table class="table" align="center">
    	    ...
    	    <tr><td width="20" colspan="4"></td><td><a href="<?php echo site_url('notapegawai') ?>" class="btn btn-default">Cancel</a></td></tr>
    	</table>
    </body>