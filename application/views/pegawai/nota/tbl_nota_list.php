    <body>
        <h2 style="margin-top:0px">Daftar Nota | 
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url('notapegawai/create/0');?>">Pembelian Produk</a></li>
                    <li><a href="<?php echo base_url('notapegawai/create/1');?>">Service</a></li>
                  </ul>
                </div>
        </h2>
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('notapegawai/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('notapegawai'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('notapegawai/read/'.$nota->id_nota),'Read'); 
				echo ' | '; 
				// echo anchor(site_url('nota/updatenew/'.$nota->id_nota),'Update'); 
				// echo ' | '; 
				echo anchor(site_url('notapegawai/delete/'.$nota->id_nota),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                echo ' | '; 
