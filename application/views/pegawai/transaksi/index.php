								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr >
											...
											<td>
											<a class="btn green" href="<?php echo base_url();?>pegawai/transaksi_proses/<?php echo $tampil['id_transaksi_header'];?>"><i class="icon-edit"></i> Proses</a>
											<a class="btn blue" href="<?php echo base_url();?>pegawai/transaksi_detail/<?php echo $tampil['id_transaksi_header'];?>/<?php echo $tampil['kode_transaksi'];?>"><i class="icon-search"></i> Detail</a>
