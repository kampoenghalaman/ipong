								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr >
											...
											<td><a class="btn green" href="<?php echo base_url();?>adminweb/admin_edit/<?php echo $tampil['id_user'];?>"><i class="icon-edit"></i> Edit</a>
											<a class="btn red" href="<?php echo base_url();?>adminweb/admin_delete/<?php echo $tampil['id_user'];?>" onclick="return confirm('Yakin Ingin Menghapus <?php echo $tampil['nama_user'];?>?')"><i class="icon-trash"></i> Delete</a>
