    ...
    <div class="row">
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="namapegawai" id="namapegawai" placeholder="Nama pegawai" value="<?php echo $namapegawai; ?>" />
        </div>
	    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="totalbiaya" id="totalbiaya" placeholder="Total biaya" value="<?php echo $totalbiaya; ?>" />
        </div>
